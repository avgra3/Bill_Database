# Generated by Django 3.2.5 on 2021-08-03 20:03
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Bill',
            fields=[
                ('billID', models.IntegerField(primary_key=True, serialize=False, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(10000)])),
        ...
        migrations.CreateModel(
            name='Carrier',
            fields=[
                ('carrierId', models.IntegerField(primary_key=True, serialize=False, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(10000)], verbose_name='Carrier ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('mbdID', models.IntegerField(default=bills.models.MonthlyBreakdown.id_default, primary_key=True, serialize=False, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(10000)], verbose_name='Monthly Billed ID')),
        ...
        migrations.CreateModel(
            name='Product',
            fields=[
                ('prodID', models.IntegerField(primary_key=True, serialize=False, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(10000)])),
        ...
        migrations.CreateModel(
            name='BillPaid',
            fields=[
                ('paidID', models.IntegerField(default=bills.models.BillPaid.id_default, primary_key=True, serialize=False, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(10000)], verbose_name='Paid ID')),
